# 5 March 2015 - R script to create Plot 4 for the first Course Project in Exploring Data
...
# Open PNG and create the graph (using 'layout()' to place the 4 panels)
...
plot(datetime, df$Voltage, type="l",
     ylab="Voltage")

plot(date_time, df$Sub_metering_1, type="l",
     xlab="",
